...
const nextConfig: NextConfig = {
  ...
  images: {
    remotePatterns: [
      ...
      // README images committed in a repo. Unscoped, unlike the patterns around
      // it: the path carries someone else's owner, repo, and branch, so there is
      // no prefix to pin — a linked repo can belong to any organisation.
